...
@pytest.fixture
def mock_boto3() -> Generator[Tuple[mock.MagicMock, mock.MagicMock, mock.MagicMock], None, None]:
    with mock.patch('boto3.Session') as m_session, mock.patch('boto3.client') as m_client:
...
def test_with_config(mock_boto3: Tuple[mock.MagicMock, mock.MagicMock, mock.MagicMock]) -> None:
    session_mock, client_mock, client_instance = mock_boto3
...
def test_endpoint_url_with_creds(mock_boto3: Tuple[mock.MagicMock, mock.MagicMock, mock.MagicMock]) -> None:
    session_mock, client_mock, client_instance = mock_boto3
...
def test_region_with_creds(mock_boto3: Tuple[mock.MagicMock, mock.MagicMock, mock.MagicMock]) -> None:
    session_mock, client_mock, client_instance = mock_boto3
    session_instance = session_mock.return_value
...
def test_session_region_fallback(mock_boto3: Tuple[mock.MagicMock, mock.MagicMock, mock.MagicMock]) -> None:
    session_mock, client_mock, client_instance = mock_boto3
    session_instance = session_mock.return_value
...
def mock_boto3_with_imports() -> Generator[
    ...
    with mock.patch('boto3.Session') as m_session, \
...
def test_bad_service_error_with_session(
        mock_boto3_with_imports: Tuple[mock.MagicMock, mock.MagicMock, mock.MagicMock, mock.MagicMock]) -> None:
...
def test_boto3_error_with_direct_client(mock_boto3: Tuple[mock.MagicMock, mock.MagicMock, mock.MagicMock]) -> None:
...
def test_generic_error_with_direct_client(mock_boto3: Tuple[mock.MagicMock, mock.MagicMock, mock.MagicMock]) -> None:
    _, client_mock, _ = mock_boto3
