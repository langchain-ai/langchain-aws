...
from langgraph_checkpoint_aws.agentcore.helpers import (
    ...
    BedrockAgentCoreClientEnhanced,
    EventProcessor,
    EventSerializer,
)
...
class TestBedrockAgentCoreClientEnhanced:
    """Test suite for BedrockAgentCoreClientEnhanced retry logic."""
    ...
    def enhanced_client(self, mock_boto_client):
        return BedrockAgentCoreClientEnhanced(mock_boto_client, max_retries=3)
    ...
    def test_retry_exponential_backoff(self, enhanced_client, mock_boto_client):
        ...
        # Should have slept at least 0.1s (first retry) + 0.2s (second retry) = 0.3s
    ...
    def test_custom_max_retries(self, mock_boto_client):
        ...
        enhanced_client = BedrockAgentCoreClientEnhanced(
