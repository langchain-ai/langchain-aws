...
class TestAsyncBedrockAgentRuntimeSessionClient:
    ...
    class TestSession:
        ...
        async def test_create_async_session(
            ...
            # Act
            response = await mock_session_client.create_session(request)
        ...
        async def test_get_session(
            ...
            # Act
            response = await mock_session_client.get_session(request)
        ...
        async def test_end_session(
            ...
            # Act
            response = await mock_session_client.end_session(request)
    ...
    class TestInvocation:
        ...
        async def test_create_invocation(
            ...
            # Act
            response = await mock_session_client.create_invocation(request)
        ...
        async def test_list_invocation(
            ...
            # Act
            response = await mock_session_client.list_invocations(request)
    ...
    class TestInvocationStep:
        ...
        async def test_put_invocation_step(
            ...
            # Act
            response = await mock_session_client.put_invocation_step(request)
        ...
        async def test_get_invocation_step(
            ...
            # Act
            response = await mock_session_client.get_invocation_step(request)
        ...
        async def test_list_invocation_steps(
            ...
            # Act
            response = await mock_session_client.list_invocation_steps(request)
