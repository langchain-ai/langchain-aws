...
# Conditional imports for Valkey functionality (both checkpoint and agentcore)
try:
    ...
    # If Valkey dependencies are not available, create placeholder classes
    ...
    AsyncValkeySaver: type[Any] = _missing_valkey_dependencies_error  # type: ignore[assignment,no-redef]
    ValkeySaver: type[Any] = _missing_valkey_dependencies_error  # type: ignore[assignment,no-redef]
