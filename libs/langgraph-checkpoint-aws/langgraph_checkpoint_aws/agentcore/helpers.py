                ...
                try:
                    ...
                    if error_code == "RetryableConflictException":
                        if attempt < self._max_retries:
                            ...
                            sleep_time = min(
                                backoff * (2**attempt), DEFAULT_MAX_BACKOFF
                            )
                            logger.warning(
...
class AgentCoreEventClient:
    ...
    def __init__(
        ...
        **boto3_kwargs,
        ...
        self.client = BedrockAgentCoreClientEnhanced(raw_client, DEFAULT_MAX_RETRIES)
