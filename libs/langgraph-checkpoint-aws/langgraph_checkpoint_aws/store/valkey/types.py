...
EmbedType = Union[Any, EmbeddingsFunc, AEmbeddingsFunc, str]  # Any represents Embeddings class
...
class ValkeyIndexConfigTyped(TypedDict):
    ...
    hnsw_ef_construction: NotRequired[int]  # Default: 200 - Search width during construction
