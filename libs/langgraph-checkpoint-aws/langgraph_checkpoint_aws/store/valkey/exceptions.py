...
class DocumentParsingError(ValkeyStoreError):
    ...
    def __init__(self, message: str, *, document_key: str | None = None, parse_type: str | None = None) -> None:
...
class SearchIndexError(ValkeyStoreError):
    ...
    def __init__(self, message: str, *, index_name: str | None = None, index_operation: str | None = None) -> None:
...
class EmbeddingGenerationError(ValkeyStoreError):
    ...
    def __init__(self, message: str, *, text_content: str | None = None, embedding_model: str | None = None) -> None:
        ...
        self.text_content = text_content[:100] + "..." if text_content and len(text_content) > 100 else text_content
...
class ValidationError(ValkeyStoreError):
    ...
    def __init__(self, message: str, *, field_name: str | None = None, field_value: str | None = None) -> None:
        ...
        self.field_value = str(field_value)[:100] + "..." if field_value and len(str(field_value)) > 100 else str(field_value) if field_value else None
